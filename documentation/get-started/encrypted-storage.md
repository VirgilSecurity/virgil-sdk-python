...
Use the [approve & publish users guide](https://github.com/VirgilSecurity/virgil-sdk-python/blob/docs-review/documentation/guides/configuration/server-configuration.md) to publish user's Virgil Card on Virgil Services.
...
![encrypted storage](https://github.com/VirgilSecurity/virgil-sdk-python/blob/docs-review/documentation/img/encrypted_storage_upload.png "Encrypt data")
...
See our [guide](https://github.com/VirgilSecurity/virgil-sdk-python/blob/docs-review/documentation/guides/virgil-card/finding-card.md) on Finding Cards for best practices on loading Alice's card.
...
![Encrypt Data](https://github.com/VirgilSecurity/virgil-sdk-python/blob/docs-review/documentation/img/encrypted_storage_download.png "Decrypt Data")
...
To decrypt data, you will need your stored Virgil Key. See the [Loading Key](https://github.com/VirgilSecurity/virgil-sdk-python/blob/docs-review/documentation/guides/virgil-key/loading-key.md) guide for more details.
